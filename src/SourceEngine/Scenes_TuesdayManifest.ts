...
const sceneDescs = [
    ...
    new TeamFortress2SceneDesc('tf_data3', 'data3 - Shattered Buildings - Unfixed'),
	new TeamFortress2SceneDesc('tf_data3_d', 'data3 - Shattered Buildings - Fixed'),
    new TeamFortress2SceneDesc('tf_data4', 'data4 - Box'),
    new TeamFortress2SceneDesc('tf_data5', 'data5 - Heavy Torus'),
    new TeamFortress2SceneDesc('tf_data6', 'data6 - City - Unfixed'),
	new TeamFortress2SceneDesc('tf_data6_d', 'data6 - City - Fixed'),
